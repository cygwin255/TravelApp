...
module.exports = "<div class=\"container\">\n  <div class=\"row\">\n    <div class=\"col-12 col-md-3 navigation\">\n      <nav class=\"container\">\n        <div class=\"row\">\n          <div class=\"nav-link col-4 col-md-12\" routerLink=\"/flights\" routerLinkActive=\"active\">\n            <i class=\"fa fa-plane\"></i>\n            Flights\n          </div>\n          <div class=\"nav-link col-4 col-md-12\" routerLink=\"/hotels\" routerLinkActive=\"active\">\n            <i class=\"fa fa-hotel\"></i>\n            Hotels\n          </div>\n          <div class=\"nav-link col-4 col-md-12\" routerLink=\"/cars\" routerLinkActive=\"active\">\n            <i class=\"fa fa-car\"></i>\n            Cars\n          </div>\n        </div>\n      </nav>\n    </div>\n    <div class=\"col-12 col-md-9\">\n      <router-outlet></router-outlet>\n      <app-history></app-history>\n    </div>\n  </div>\n</div>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_endpoints_service_endpoints_service__ = __webpack_require__("./src/app/shared/endpoints-service/endpoints.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_history_service_history_service__ = __webpack_require__("./src/app/shared/history-service/history.service.ts");
...
var AppComponent = (function () {
    ...
    AppComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_1__shared_endpoints_service_endpoints_service__["a" /* EndpointsService */], __WEBPACK_IMPORTED_MODULE_2__shared_history_service_history_service__["a" /* HistoryService */]]
        })
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__travel_travel_state__ = __webpack_require__("./src/app/travel/travel-state.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__shared_datepicker_datepicker_component__ = __webpack_require__("./src/app/shared/datepicker/datepicker.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__shared_auto_dropdown_auto_dropdown_component__ = __webpack_require__("./src/app/shared/auto-dropdown/auto-dropdown.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__travel_flights_travel_flights_travel_component__ = __webpack_require__("./src/app/travel/flights-travel/flights-travel.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__shared_endpoints_service_endpoints_service__ = __webpack_require__("./src/app/shared/endpoints-service/endpoints.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__shared_travel_wrapper_travel_wrapper_component__ = __webpack_require__("./src/app/shared/travel-wrapper/travel-wrapper.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__shared_history_service_history_service__ = __webpack_require__("./src/app/shared/history-service/history.service.ts");
...
var appRoutes = [
    {
        path: 'flights',
        component: __WEBPACK_IMPORTED_MODULE_11__travel_flights_travel_flights_travel_component__["a" /* FlightsTravelComponent */],
    },
    {
        path: 'hotels',
        component: __WEBPACK_IMPORTED_MODULE_6__travel_travel_component__["a" /* TravelComponent */],
        data: {
            state: __WEBPACK_IMPORTED_MODULE_7__travel_travel_state__["a" /* TravelState */].Hotels
        }
    },
    {
        path: 'cars',
        component: __WEBPACK_IMPORTED_MODULE_6__travel_travel_component__["a" /* TravelComponent */],
        data: {
            state: __WEBPACK_IMPORTED_MODULE_7__travel_travel_state__["a" /* TravelState */].Cars
        }
    },
    {
        path: '**',
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["J" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_9__shared_datepicker_datepicker_component__["a" /* DatepickerComponent */],
                __WEBPACK_IMPORTED_MODULE_10__shared_auto_dropdown_auto_dropdown_component__["a" /* AutoDropdownComponent */],
                __WEBPACK_IMPORTED_MODULE_11__travel_flights_travel_flights_travel_component__["a" /* FlightsTravelComponent */],
                __WEBPACK_IMPORTED_MODULE_13__shared_travel_wrapper_travel_wrapper_component__["a" /* TravelWrapperComponent */],
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_12__shared_endpoints_service_endpoints_service__["a" /* EndpointsService */], __WEBPACK_IMPORTED_MODULE_14__shared_history_service_history_service__["a" /* HistoryService */]],
...
module.exports = "<div class=\"history\">\r\n  <div class=\"row\" *ngFor=\"let item of (historyService.historyChanged$ | async).reverse(); let i = index\">\r\n    <div class=\"col\">\r\n      <div class=\"row align-items-center\" [ngSwitch]=\"item.type\">\r\n        <ng-container *ngSwitchCase=\"HistoryType.FlightSearch\">\r\n          <div class=\"col-1\">\r\n            <i class=\"fa fa-plane\"></i>\r\n          </div>\r\n\r\n          <div class=\"col-5\">\r\n            {{ item.data.startDate | date: 'MMMM d, YY' }} - {{ item.data.endDate | date: 'MMMM d, YY' }}\r\n          </div>\r\n\r\n          <div class=\"col-5\">\r\n            {{ item.data.origin }}\r\n            <i class=\"fa fa-angle-double-right\" aria-hidden=\"true\"></i>\r\n            {{ item.data.destination }}\r\n          </div>\r\n        </ng-container>\r\n        <div class=\"col-1 align-self-center\">\r\n          <a href=\"#\" (click)=\"historyService.remove(i)\">\r\n            <i class=\"fa fa-trash\" aria-hidden=\"true\"></i>\r\n          </a>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_history_service_history_service__ = __webpack_require__("./src/app/shared/history-service/history.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HistoryComponent = (function () {
    function HistoryComponent(historyService) {
        ...
        this.HistoryType = __WEBPACK_IMPORTED_MODULE_1__shared_history_service_history_service__["b" /* HistoryType */];
    }
    HistoryComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__shared_history_service_history_service__["a" /* HistoryService */]])
    ], HistoryComponent);
...
/***/ "./src/app/shared/auto-dropdown/auto-dropdown.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AutoDropdownComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__controlValueAccessorBase_controlValueAccessorBase__ = __webpack_require__("./src/app/shared/controlValueAccessorBase/controlValueAccessorBase.ts");
...
var AutoDropdownComponent = (function (_super) {
    __extends(AutoDropdownComponent, _super);
    function AutoDropdownComponent() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.searchOnPlainItems = false;
        return _this;
    }
    AutoDropdownComponent_1 = AutoDropdownComponent;
    AutoDropdownComponent.prototype.ngOnInit = function () {
        this.getItemsToDisplay();
    };
    AutoDropdownComponent.prototype.writeValue = function (item) {
        if (!item) {
            this.searchValue = null;
            this.getItemsToDisplay();
        }
        _super.prototype.writeValue.call(this, item);
    };
    AutoDropdownComponent.prototype.selectItem = function (item) {
        this.value = item;
        this.onChange(item);
        this.searchValue = item.name;
    };
    AutoDropdownComponent.prototype.openDropdown = function () {
        if (!this.dropdownInstance.isOpen()) {
            this.dropdownInstance.open();
        }
    };
    AutoDropdownComponent.prototype.onBlur = function () {
        this.onTouched();
        if (this.value && this.searchValue !== this.value.name) {
            this.searchValue = this.value.name;
        }
    };
    AutoDropdownComponent.prototype.getItemsToDisplay = function () {
        var _this = this;
        if (this.items) {
            if (!this.searchValue || !this.searchOnPlainItems) {
                this.displayObservable = __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["a" /* Observable */].of(this.items);
                return;
            }
            this.displayObservable = __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["a" /* Observable */].of(this.items.filter(function (x) { return x.name.includes(_this.searchValue); }));
        }
        else {
    ...
    ], AutoDropdownComponent.prototype, "caption", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* Input */])(),
        __metadata("design:type", String)
    ], AutoDropdownComponent.prototype, "placeholder", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* Input */])(),
        __metadata("design:type", Array)
    ], AutoDropdownComponent.prototype, "items", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* Input */])(),
        __metadata("design:type", Function)
    ], AutoDropdownComponent.prototype, "itemsObservableFunction", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* Input */])(),
        __metadata("design:type", Object)
    ], AutoDropdownComponent.prototype, "searchOnPlainItems", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* Input */])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["_7" /* TemplateRef */])
    ], AutoDropdownComponent.prototype, "displayTemplate", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_10" /* ViewChild */])('dropdownInstance'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_2__ng_bootstrap_ng_bootstrap__["a" /* NgbDropdown */])
    ], AutoDropdownComponent.prototype, "dropdownInstance", void 0);
    AutoDropdownComponent = AutoDropdownComponent_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-autodropdown',
            template: __webpack_require__("./src/app/shared/auto-dropdown/auto-dropdown.component.html"),
            styles: [__webpack_require__("./src/app/shared/auto-dropdown/auto-dropdown.component.scss")],
            changeDetection: __WEBPACK_IMPORTED_MODULE_0__angular_core__["j" /* ChangeDetectionStrategy */].OnPush,
            providers: [
                {
                    provide: __WEBPACK_IMPORTED_MODULE_3__angular_forms__["e" /* NG_VALUE_ACCESSOR */],
                    multi: true,
                    useExisting: Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_16" /* forwardRef */])(function () { return AutoDropdownComponent_1; }),
                }
            ]
        })
    ], AutoDropdownComponent);
    return AutoDropdownComponent;
    var AutoDropdownComponent_1;
}(__WEBPACK_IMPORTED_MODULE_1__controlValueAccessorBase_controlValueAccessorBase__["a" /* ControlValueAccessorBase */]));



/***/ }),

/***/ "./src/app/shared/controlValueAccessorBase/controlValueAccessorBase.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ControlValueAccessorBase; });
var ControlValueAccessorBase = (function () {
    function ControlValueAccessorBase() {
    }
    ControlValueAccessorBase.prototype.writeValue = function (newValue) {
        this.value = newValue;
    };
    ControlValueAccessorBase.prototype.registerOnChange = function (fn) {
        this.onChange = fn;
    };
    ControlValueAccessorBase.prototype.registerOnTouched = function (fn) {
        this.onTouched = fn;
    };
    ControlValueAccessorBase.prototype.onChange = function (_) {
    };
    ControlValueAccessorBase.prototype.onTouched = function () {
    };
...
/***/ "./src/app/shared/datepicker/datepicker.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"datepicker\">\r\n  <label class=\"d-inline\">\r\n    {{ caption }}\r\n    <div class=\"datepicker-container\">\r\n      <input\r\n        ngbDatepicker\r\n        #datepickerInstance=\"ngbDatepicker\"\r\n        class=\"form-control form-control-sm datepicker-input\"\r\n        type=\"text\"\r\n        [(ngModel)]=\"value\"\r\n        (blur)=\"onTouched()\"\r\n        (ngModelChange)=\"onModelChange($event)\"\r\n        (click)=\"datepickerInstance.toggle()\"\r\n        [placement]=\"placement\"\r\n        navigation=\"select\"\r\n        [placeholder]=\"placeholder || ''\"\r\n        readonly\r\n      />\r\n      <div class=\"datepicker-calendar\">\r\n        <i class=\"fa fa-calendar\" aria-hidden=\"true\"></i>\r\n      </div>\r\n    </div>\r\n  </label>\r\n\r\n</div>\r\n"

/***/ }),

/***/ "./src/app/shared/datepicker/datepicker.component.scss":
/***/ (function(module, exports) {

module.exports = ".datepicker .datepicker-container {\n  position: relative;\n  cursor: pointer; }\n  .datepicker .datepicker-container input[readonly] {\n    background-color: white; }\n  .datepicker .datepicker-container .datepicker-input {\n    padding-right: 35px;\n    pointer-events: none; }\n  .datepicker .datepicker-container .datepicker-calendar {\n    position: absolute;\n    bottom: 5px;\n    right: 10px; }\n"
...
var DatepickerComponent = (function (_super) {
    ...
    DatepickerComponent.prototype.onModelChange = function (event) {
        var _this = this;
        this.onChange(event);
        setTimeout(function () {
            _this.datepickerInstance.close();
        }, 0);
    };
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* Input */])(),
        __metadata("design:type", String)
    ], DatepickerComponent.prototype, "caption", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* Input */])(),
        __metadata("design:type", String)
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* Input */])(),
        __metadata("design:type", Object)
    ], DatepickerComponent.prototype, "placement", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_10" /* ViewChild */])('datepickerInstance'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_3__ng_bootstrap_ng_bootstrap__["b" /* NgbInputDatepicker */])
    ], DatepickerComponent.prototype, "datepickerInstance", void 0);
    DatepickerComponent = DatepickerComponent_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-datepicker',
            template: __webpack_require__("./src/app/shared/datepicker/datepicker.component.html"),
            styles: [__webpack_require__("./src/app/shared/datepicker/datepicker.component.scss")],
            host: {
            ...
            providers: [
                {
                    ...
                    multi: true,
                    useExisting: Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_16" /* forwardRef */])(function () { return DatepickerComponent_1; }),
                }
            ]
        }),
...
/***/ "./src/app/shared/endpoints-service/cities.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CitiesArray; });
var CitiesArray = [
...
/***/ "./src/app/shared/endpoints-service/endpoints.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cities__ = __webpack_require__("./src/app/shared/endpoints-service/cities.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EndpointsService = (function () {
    ...
    EndpointsService.prototype.fetchCities = function (searchPattern) {
        var filteredArray = searchPattern ? __WEBPACK_IMPORTED_MODULE_2__cities__["a" /* CitiesArray */].filter(function (x) { return x.city.includes(searchPattern); }) : __WEBPACK_IMPORTED_MODULE_2__cities__["a" /* CitiesArray */];
        ...
        return __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["a" /* Observable */].fromPromise(delayPromise);
    };
...
/***/ "./src/app/shared/history-service/history.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return HistoryService; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return HistoryType; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
...
var HistoryService = (function () {
    function HistoryService() {
        this.historyChanged = new __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__["a" /* BehaviorSubject */](this.getStorage());
        this.historyChanged$ = this.historyChanged.asObservable();
        console.log(this.getStorage());
    }
    HistoryService.prototype.add = function (type, data) {
    ...
    HistoryService.prototype.getStorage = function () {
        return this.load() || [];
    };
    HistoryService.prototype.remove = function (id) {
    ...
    HistoryService.prototype.save = function (data) {
...
(function (HistoryType) {
    HistoryType[HistoryType["FlightSearch"] = 0] = "FlightSearch";
    HistoryType[HistoryType["HotelSearch"] = 1] = "HotelSearch";
    HistoryType[HistoryType["CarSearch"] = 2] = "CarSearch";
})(HistoryType || (HistoryType = {}));


/***/ }),

/***/ "./src/app/shared/travel-base/travel-base.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TravelBase; });
...
var TravelBase = (function () {
    function TravelBase(fb, endpoints) {
        var _this = this;
        this.fb = fb;
        this.endpoints = endpoints;
        this.getCitiesObservable = function (searchPattern) {
            return _this.endpoints.fetchCities(searchPattern)
                .map(function (cities) {
                return cities.map(function (item) { return ({
                    name: item.city,
                    data: item.state
                }); });
            });
    ...
    TravelBase.prototype.buildFormGroup = function (additionalItems) {
        this.form = this.fb.group(__assign({ startDate: [null, __WEBPACK_IMPORTED_MODULE_0__angular_forms__["g" /* Validators */].required], endDate: [null, __WEBPACK_IMPORTED_MODULE_0__angular_forms__["g" /* Validators */].required] }, additionalItems));
    };
    TravelBase.prototype.reset = function () {
        this.form.reset();
    };
    TravelBase.prototype.validate = function () {
        if (!this.form.valid) {
...
/***/ "./src/app/shared/travel-wrapper/travel-wrapper.component.html":
/***/ (function(module, exports) {

module.exports = "<form [formGroup]=\"form\" class=\"form-validation\">\r\n  <div class=\"row\">\r\n    <div class=\"col-6 form-group\">\r\n      <app-datepicker\r\n        placeholder=\"Select date\"\r\n        caption=\"Start Date\"\r\n        formControlName=\"startDate\"\r\n      ></app-datepicker>\r\n    </div>\r\n    <div class=\"col-6 form-group\">\r\n      <app-datepicker\r\n        placeholder=\"Select date\"\r\n        placement=\"bottom-right\"\r\n        caption=\"End Date\"\r\n        formControlName=\"endDate\"\r\n      ></app-datepicker>\r\n    </div>\r\n  </div>\r\n\r\n  <ng-content></ng-content>\r\n\r\n  <div class=\"row\">\r\n    <div class=\"col-auto ml-auto\">\r\n      <button class=\"btn btn-link\" type=\"button\" (click)=\"reset.emit()\">clear</button>\r\n      <button class=\"btn btn-success\" type=\"button\" (click)=\"search.emit()\">Search</button>\r\n    </div>\r\n  </div>\r\n</form>\r\n"

/***/ }),

/***/ "./src/app/shared/travel-wrapper/travel-wrapper.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TravelWrapperComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
...
var TravelWrapperComponent = (function () {
    function TravelWrapperComponent() {
    ...
    ], TravelWrapperComponent.prototype, "form", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Q" /* Output */])(),
        __metadata("design:type", Object)
    ], TravelWrapperComponent.prototype, "search", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Q" /* Output */])(),
        __metadata("design:type", Object)
    ], TravelWrapperComponent.prototype, "reset", void 0);
    TravelWrapperComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-travel-wrapper',
            template: __webpack_require__("./src/app/shared/travel-wrapper/travel-wrapper.component.html")
        })
    ], TravelWrapperComponent);
    return TravelWrapperComponent;
}());
...
/***/ "./src/app/travel/flights-travel/flights-travel.component.html":
/***/ (function(module, exports) {

module.exports = "<app-travel-wrapper\r\n  [form]=\"form\"\r\n  (reset)=\"reset()\"\r\n  (search)=\"search()\"\r\n  [formGroup]=\"form\"\r\n>\r\n  <div class=\"row\">\r\n    <div class=\"col form-group\">\r\n      <app-autodropdown\r\n        placeholder=\"Type to search\"\r\n        [displayTemplate]=\"dpDisplayTemplate\"\r\n        caption=\"From\"\r\n        formControlName=\"origin\"\r\n        [itemsObservableFunction]=\"getCitiesObservable\"\r\n      ></app-autodropdown>\r\n    </div>\r\n  </div>\r\n  <div class=\"row\">\r\n    <div class=\"col form-group\">\r\n      <app-autodropdown\r\n        placeholder=\"Type to search\"\r\n        [displayTemplate]=\"dpDisplayTemplate\"\r\n        caption=\"To\"\r\n        formControlName=\"destination\"\r\n        [itemsObservableFunction]=\"getCitiesObservable\"\r\n      ></app-autodropdown>\r\n    </div>\r\n  </div>\r\n</app-travel-wrapper>\r\n\r\n<ng-template #dpDisplayTemplate let-item>\r\n  {{ item.name }} ({{ item.data }})\r\n</ng-template>\r\n"

/***/ }),

/***/ "./src/app/travel/flights-travel/flights-travel.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FlightsTravelComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_forms__ = __webpack_require__("./node_modules/@angular/forms/esm5/forms.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_travel_base_travel_base__ = __webpack_require__("./src/app/shared/travel-base/travel-base.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_endpoints_service_endpoints_service__ = __webpack_require__("./src/app/shared/endpoints-service/endpoints.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_history_service_history_service__ = __webpack_require__("./src/app/shared/history-service/history.service.ts");
...
var FlightsTravelComponent = (function (_super) {
    __extends(FlightsTravelComponent, _super);
    function FlightsTravelComponent(fb, endpointsSevice, historyService) {
        var _this = _super.call(this, fb, endpointsSevice) || this;
        _this.historyService = historyService;
        _this.buildFormGroup({
            origin: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["g" /* Validators */].required],
            destination: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["g" /* Validators */].required]
        });
        return _this;
    }
    FlightsTravelComponent.prototype.search = function () {
        if (!this.validate()) {
            return;
        }
        var formValue = this.form.value;
        this.historyService.add(__WEBPACK_IMPORTED_MODULE_4__shared_history_service_history_service__["b" /* HistoryType */].FlightSearch, {
            startDate: Object(__WEBPACK_IMPORTED_MODULE_5__utils__["a" /* ngbDateStructToDate */])(formValue.startDate),
            endDate: Object(__WEBPACK_IMPORTED_MODULE_5__utils__["a" /* ngbDateStructToDate */])(formValue.endDate),
            origin: formValue.origin.name,
            destination: formValue.destination.name
        });
    };
    FlightsTravelComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-flights-travel',
            template: __webpack_require__("./src/app/travel/flights-travel/flights-travel.component.html")
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["a" /* FormBuilder */],
            __WEBPACK_IMPORTED_MODULE_3__shared_endpoints_service_endpoints_service__["a" /* EndpointsService */],
            __WEBPACK_IMPORTED_MODULE_4__shared_history_service_history_service__["a" /* HistoryService */]])
    ], FlightsTravelComponent);
    return FlightsTravelComponent;
}(__WEBPACK_IMPORTED_MODULE_2__shared_travel_base_travel_base__["a" /* TravelBase */]));



/***/ }),

/***/ "./src/app/travel/travel-state.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TravelState; });
var TravelState;
(function (TravelState) {
    TravelState[TravelState["Flights"] = 0] = "Flights";
    TravelState[TravelState["Hotels"] = 1] = "Hotels";
    TravelState[TravelState["Cars"] = 2] = "Cars";
...
module.exports = "<form [formGroup]=\"form\">\r\n  <div class=\"row\">\r\n    <div class=\"col-6 form-group\">\r\n      <app-datepicker\r\n        caption=\"Start Date\"\r\n        formControlName=\"startDate\"\r\n      ></app-datepicker>\r\n    </div>\r\n    <div class=\"col-6 form-group\">\r\n      <app-datepicker\r\n        placement=\"bottom-right\"\r\n        caption=\"End Date\"\r\n        formControlName=\"endDate\"\r\n      ></app-datepicker>\r\n    </div>\r\n  </div>\r\n  <div class=\"row\">\r\n    <div class=\"col form-group\">\r\n      <app-autodropdown\r\n        caption=\"Location\"\r\n        formControlName=\"test\"\r\n        [itemsObservableFunction]=\"itemsObservableFunction\"\r\n      ></app-autodropdown>\r\n    </div>\r\n  </div>\r\n  <div class=\"row\">\r\n    <div class=\"col\">\r\n      <button class=\"btn btn-link\" type=\"button\" (click)=\"reset()\">clear</button>\r\n      <button class=\"btn btn-success\" type=\"button\" (click)=\"search()\" [disabled]=\"!form.valid\">Search</button>\r\n    </div>\r\n  </div>\r\n\r\n</form>\r\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__travel_state__ = __webpack_require__("./src/app/travel/travel-state.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_forms__ = __webpack_require__("./node_modules/@angular/forms/esm5/forms.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__ = __webpack_require__("./node_modules/rxjs/_esm5/Observable.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_travel_base_travel_base__ = __webpack_require__("./src/app/shared/travel-base/travel-base.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_endpoints_service_endpoints_service__ = __webpack_require__("./src/app/shared/endpoints-service/endpoints.service.ts");
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var TravelComponent = (function (_super) {
    __extends(TravelComponent, _super);
    function TravelComponent(route, fb, endpointsSevice) {
        var _this = _super.call(this, fb, endpointsSevice) || this;
        _this.route = route;
        _this.currentState = __WEBPACK_IMPORTED_MODULE_2__travel_state__["a" /* TravelState */].Flights;
        ...
        _this.buildFormGroup({
            test: [null, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["g" /* Validators */].required]
        });
        return _this;
    }
    ...
    TravelComponent.prototype.itemsObservableFunction = function (name) {
        var arr = [];
        for (var i = 0; i < 100; i++) {
            arr.push({
                id: i,
        ...
        var filteredArray = name ? arr.filter(function (x) { return x.name.includes(name); }) : arr;
        filteredArray = filteredArray.slice(0, 10);
        var delayPromise = new Promise(function (resolve) {
            setTimeout(function () {
                resolve(filteredArray);
        ...
        return __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["a" /* Observable */].fromPromise(delayPromise);
    };
    TravelComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */],
            ...
            __WEBPACK_IMPORTED_MODULE_6__shared_endpoints_service_endpoints_service__["a" /* EndpointsService */]])
    ], TravelComponent);
    return TravelComponent;
}(__WEBPACK_IMPORTED_MODULE_5__shared_travel_base_travel_base__["a" /* TravelBase */]));
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = ngbDateStructToDate;
function ngbDateStructToDate(ngbDate) {
